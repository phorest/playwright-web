...
test('Login with user interaction and I can not log out by clicking on the back button @login @ui', async ({ page }) => {
...
test('As a user, I should be able to successfully logout @login @ui', async ({ page, request }) => {
